...
python evaluation/extract.py --input $OUTPUT_DIR/${INPUT_FILENAME}_result.json --output $OUTPUT_DIR/${INPUT_FILENAME}_result_judged.json --model_name deepseek-reasoner
